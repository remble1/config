...
" enable line numbers
" let g:color_coded_filetypes = ['c', 'cpp', 'objc', 'cu']
...
let g:ctrlsf_auto_focus = {
    \ "at": "start"
    \ }
let g:ctrlsf_ignore_dir = ['docker', 'tags', 'cmake-*', 'build', 'build30']
...
let g:ctrlp_custom_ignore = 'tags\|docker\|docker*\|cmake-*\|build*\|build30*'
